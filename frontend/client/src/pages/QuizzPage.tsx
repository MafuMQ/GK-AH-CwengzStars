...
const quizData = [
    {
        ...
        questions: [
            {
                difficulty: "Easy",
                question: "A pop-up ad says you won a prize, and all you have to do is click the button to claim it. What should you do?",
                choices: [
                    "Click the button—it's a prize!",
                    "Close the pop-up window without clicking anything.",
                    "Reply to the ad with your email address."
                ],
                answer: 1
            },
            {
                difficulty: "Easy",
                question: "What is the best way to know if an online offer for a free item is probably a trick?",
                choices: [
                    "If it's a brand you like.",
                    "If it offers a prize that sounds too good to be true.",
            ...
            {
                difficulty: "Easy",
                question: "What does a 'phisher' want from you?",
                choices: [
                    "To invite you to their private party.",
                    "To give you a free coupon.",
                    "To trick you into giving them personal information like passwords."
                ],
                answer: 2
            },
            {
                difficulty: "Medium",
                question: "You see a news headline that says something unbelievable. What is the most reliable way to check if it's true?",
                choices: [
                    "Ask a friend if they saw the same news.",
                    "Look for the same story on two or three well-known, reputable news sites.",
                    "Read the comments on the social media post."
                ],
                answer: 1
            },
            {
                difficulty: "Medium",
                question: "A friend sends you a link to a 'funny video,' but the link looks weird. How should you be sure it is safe to open?",
                choices: [
                    "Click it and see what happens.",
                    "Text your friend separately to ask if they really sent the link.",
                    "Assume it's fine because your friend sent it."
                ],
                answer: 1
            },
            {
                difficulty: "Medium",
                question: "An online quiz asks you to enter your birthday and mother's maiden name to find out which animal you are. Why is this a bad idea?",
                choices: [
                    "The results might be inaccurate.",
                    "That information can be used to guess your passwords.",
                    "The quiz might not be fun."
                ],
                answer: 1
            },
            {
                difficulty: "Hard",
                question: "A social media post from an account you follow uses a stolen photo and claims to have an emotional story to get likes and shares. What is this tactic called?",
                choices: [
                    "Catfishing.",
                    "Clickbaiting.",
                    "Content farming."
            ...
            {
                difficulty: "Hard",
                question: "A friend sends you a message with a dramatic story and a plea to share it immediately. You're not sure if it's true. What should you do?",
                choices: [
                    "Share it with everyone, because it's better to be safe than sorry.",
                    "Politely ask your friend to verify the story before sharing it further.",
                    "Use a search engine or a fact-checking site to confirm the story before sharing."
                ],
                answer: 2
            },
            {
                difficulty: "Hard",
                question: "You see a political ad that shows a clip of a politician saying something shocking. What is the best way to verify if the video is real or a 'deepfake'?",
                choices: [
                    "Believe it, because seeing is believing.",
                    "Check the source and look for other reports on the same event from trusted news outlets.",
                    "Show it to your friends and get their opinion."
                ],
                answer: 1
            },
            {
                difficulty: "Hard",
                question: "You see a post that uses a manipulated photo to create a false story. What is the most effective way to identify the photo as fake?",
                choices: [
                    "Wait and see if it appears on the news.",
                    "Use a reverse image search to find the original source of the photo.",
                    "Look for similar stories that use different pictures."
                ],
                answer: 1
            }
        ]
...
const Quizz = () => {
    ...
    // Reset quiz and randomize questions when switching category
                                ...
                                const colors = [
                                    {
                                        ...
                                        inactive: "bg-white text-red-700 hover:bg-red-100 border-red-300"
                                    },
                                    {
                                        active: "bg-green-600 text-white border-green-600",
                                        inactive: "bg-white text-green-700 hover:bg-green-100 border-green-300"
                                    },
                                    {
                                        active: "bg-blue-600 text-white border-blue-600",
                                        inactive: "bg-white text-blue-700 hover:bg-blue-100 border-blue-300"
                                    },
                                    {
                                        active: "bg-yellow-500 text-white border-yellow-500",
                                        inactive: "bg-white text-yellow-700 hover:bg-yellow-100 border-yellow-300"
                                    }
                                ];
