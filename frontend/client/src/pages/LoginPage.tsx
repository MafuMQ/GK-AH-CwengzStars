  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-r from-pink-200 to-blue-200 p-6">
      ...
      <form onSubmit={handleSubmit} className='py-5'>
        ...
        <button type="submit" className="w-[100%] bg-primary text-white font-semibold py-2 px-4 rounded-md hover:bg-blue-600 transition duration-200 flex items-center justify-center mt-4"><span className="ml-2">Log In</span></button>
      </form>

      <div className="justify-center items-center w-full px-4 md:px-0">
        <br/><hr/><br/>
        <button type="button" onClick={handleGoogleLogin} className="w-[100%] bg-white text-gray-700 font-semibold py-2 px-4 rounded-md hover:bg-gray-100 transition duration-200 flex items-center justify-center border"> <FcGoogle className="w-6 h-6" /><span className="ml-2">Sign in with Google</span>
        </button>                    
      </div>
